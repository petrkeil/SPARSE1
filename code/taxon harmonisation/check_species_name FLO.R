...
# 2) Data from table
mammals <- read_csv('speciesAccess.csv')
mammlas_species_check <- check_name(mammals$verbatimIdentification)
mammlas_species_check

write.csv(mammlas_species_check, "speciesRresolved_ITIS&IUCN_FloScript_unchanged.csv")
